...
def _creator_stats(db: Session, profile_id: str) -> dict:
    ...
    Uses the Order fields currently used by BeatHub:
        gross_amount
        commission_amount
        net_amount
...
def _dashboard_context(
    ...
    #
    # IMPORTANT:
    # The public producer store is based on the producer
    # profile slug.
    #
    # This produces:
    # /store/<producer-slug>
    #
    # The public store router must handle this URL.
    # --------------------------------------------------------
