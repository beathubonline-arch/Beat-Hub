...
```
Provides safe defaults so dashboard-related templates do not
fail when optional values are unavailable.
"""
...
"""
Return all tracks owned by the creator.

```
These are supplied to dashboard.html instead of passing
an empty tracks list.
"""
...
"""
Return all albums owned by the creator.
"""
...
Admin/payment processing can approve/process the request.
"""
