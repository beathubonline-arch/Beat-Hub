...
class CreatorSalesHistoryTests(unittest.TestCase):
    def test_unified_history_combines_music_and_merchandise(self):
        ...
        try:
            history._music_sales = lambda *_: [{
                "id": "music-1", "order_number": "BH-MUSIC-1", "buyer": "Mary",
                "product": "Afro Beat", "type": "music", "type_label": "Beat / Track",
                "gross": Decimal("2000"), "commission": Decimal("200"), "net": Decimal("1800"),
                "status": "Completed", "date": when_2, "quantity": 1,
            }]
            history._merch_sales = lambda *_: [{
                "id": "merch-1", "order_number": "BM-MERCH-1", "buyer": "John",
                "product": "Bono Hoodie", "type": "merchandise", "type_label": "Merchandise",
                "gross": Decimal("3000"), "commission": Decimal("300"), "net": Decimal("2700"),
                "status": "Paid", "date": when_1, "quantity": 1,
            }]
    ...
    def test_history_filters_merchandise_and_paginates(self):
        ...
        try:
            history._music_sales = lambda *_: [{
                "id": "music-1", "order_number": "M1", "buyer": "Mary",
                "product": "Beat", "type": "music", "type_label": "Beat / Track",
                "gross": Decimal("1000"), "commission": Decimal("100"), "net": Decimal("900"),
                "status": "Completed", "date": datetime(2026, 8, 1), "quantity": 1,
            }]
            history._merch_sales = lambda *_: [{
                "id": "merch-1", "order_number": "X1", "buyer": "John",
                "product": "Hoodie", "type": "merchandise", "type_label": "Merchandise",
                "gross": Decimal("3000"), "commission": Decimal("300"), "net": Decimal("2700"),
                "status": "Paid", "date": datetime(2026, 8, 2), "quantity": 2,
            }]
